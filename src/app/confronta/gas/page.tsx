              ...
              <div className="mb-6">
                ...
                <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded-r-lg flex items-start gap-3 mt-4">
                  ...
                  <p className="text-xs text-yellow-800">
                    <strong>Nota sulla trasparenza:</strong> confrontiamo solo la parte variabile (Materia Gas). I costi fissi sono uguali per tutti e si elidono; il PCV è escluso perché è leva della consulenza personalizzata.
                  </p>
                </div>
              </div>
